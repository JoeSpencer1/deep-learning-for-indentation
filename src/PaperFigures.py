...
plt.savefig("/Users/Joe/Desktop/figure26.png")
plt.show()
'''
'''
n = [0, 1, 2, 3, 4, 5, 6, 8, 10, 20]
...
plt.subplots_adjust(bottom=0.18)
plt.suptitle("$\sigma_{y}$: Average and distribution comparison for B3090", y=0.05, fontsize=16)
plt.savefig("/Users/Joe/Desktop/figure27.png")
plt.show()
'''
'''
n = [0, 1, 2, 3, 4, 5, 6, 8, 10, 20]
...
plt.subplots_adjust(bottom=0.18)
plt.suptitle("$\sigma_{y}$: Average and distribution comparison for B3090", y=0.05, fontsize=16)
plt.savefig("/Users/Joe/Desktop/figure28.png")
plt.show()
'''
'''
n = [0, 1, 2, 3, 4, 5, 6, 8, 10, 20]
...
plt.savefig("/Users/Joe/Desktop/figure29.png")
plt.show()
'''
'''
n = [0, 1, 2, 3, 4, 5, 6, 8, 10, 20]
...
plt.savefig("/Users/Joe/Desktop/figure30.png")
plt.show()
'''
'''
n = [0, 1, 2, 3, 4, 5, 6, 8, 10, 20]
...
plt.savefig("/Users/Joe/Desktop/figure31.png")
plt.show()
'''
