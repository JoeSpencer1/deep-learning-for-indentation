...
title2 = '../data/Ti33_' + temperature + 'b.csv'
condition = res['md'] < mdif
selection = res[condition]
selection.to_csv(title2, index=False)

title3 = '../data/Ti33_' + temperature + 'c.csv'
condition = res['hmax(nm)'] < max
selection = res[condition]
selection.to_csv(title3, index=False)